...
public final class ActivityAlunoBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAlunoBinding(@NonNull LinearLayout rootView, @NonNull Button button3,
      @NonNull Button button4, @NonNull Button buttonCadeiras, @NonNull Button buttonHorarios,
      @NonNull ImageView buttonVoltar, @NonNull TextView nomeAluno) {
  ...
  @NonNull
  public static ActivityAlunoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAlunoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_aluno, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAlunoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.nome_aluno;
      TextView nomeAluno = ViewBindings.findChildViewById(rootView, id);
      if (nomeAluno == null) {
        break missingId;
      }

      return new ActivityAlunoBinding((LinearLayout) rootView, button3, button4, buttonCadeiras,
          buttonHorarios, buttonVoltar, nomeAluno);
    }
